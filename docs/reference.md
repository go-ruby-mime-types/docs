...
The public API lives at the module root (`github.com/go-ruby-mime-types/mime-types`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `mime-types`, while the surface follows
...
```go
import "github.com/go-ruby-mime-types/mime-types"
```
...
- **[pkg.go.dev/github.com/go-ruby-mime-types/mime-types](https://pkg.go.dev/github.com/go-ruby-mime-types/mime-types)**

The module's [README](https://github.com/go-ruby-mime-types/mime-types#readme) carries worked
