...
`go-ruby-mime-types/mime-types` reimplements Ruby's `mime-types` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-mime-types/mime-types` directly, with no Ruby runtime;
