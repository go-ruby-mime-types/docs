# go-ruby-mime-types documentation

**Pure-Go, MRI-faithful Ruby mime-types (no cgo)**

`go-ruby-mime-types/mime-types` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `mime-types`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-mime-types/mime-types`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `mime-types`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`mime-types`](https://github.com/go-ruby-mime-types/mime-types) | the library — Ruby's `mime-types` in pure Go |
| [`docs`](https://github.com/go-ruby-mime-types/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-mime-types.github.io`](https://github.com/go-ruby-mime-types/go-ruby-mime-types.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-mime-types/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-mime-types/mime-types](https://github.com/go-ruby-mime-types/mime-types).
